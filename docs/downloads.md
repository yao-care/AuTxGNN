...
nav_order: 94
permalink: /downloads/
description: "AuTxGNN open data downloads: FHIR resources, prediction results and search index."
---
...
<li>When citing, credit AuTxGNN (藥提醒科技有限公司) and cite the original TxGNN paper.</li>
