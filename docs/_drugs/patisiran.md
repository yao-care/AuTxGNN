...
Patisiran (DrugBank DB14582) is an siRNA therapeutic approved for hereditary transthyretin-mediated (hATTR) amyloidosis with polyneuropathy, silencing TTR mRNA production in the liver.
The TxGNN model predicts it may be effective for **Dermatitis**, but this prediction is currently supported by **no clinical trials** and **no published literature** — it rests on the model score alone.
