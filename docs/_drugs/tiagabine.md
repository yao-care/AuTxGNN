...
Tiagabine is **not currently marketed in Australia** and has **no ARTG entries** in this evidence pack (`market_status: 未上市`, `total_licenses: 0`). No product listing table can be generated.
