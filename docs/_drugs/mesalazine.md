...
No ARTG entries are recorded in this data pack (`market_status: Not marketed`, `total_licenses: 0`). Mesalazine's Australian market/registration status could not be confirmed from the data provided.
