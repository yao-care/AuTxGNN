...
Vildagliptin has **0 ARTG entries** and is currently **not marketed** in Australia (`total_licenses: 0`, `market_status: Not marketed`). No product licence data is available to summarise.
