...
**Rationale:**
This prediction (severe nonproliferative diabetic retinopathy) has no clinical trial or literature support — it is an L5, model-score-only signal at decision stage S0. The mechanistic rationale is plausible but entirely inferential.
