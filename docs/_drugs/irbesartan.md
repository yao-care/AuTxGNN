...
Irbesartan is an angiotensin II receptor blocker (ARB) used internationally to treat hypertension and diabetic nephropathy, with landmark Phase 3 evidence from the IDNT and RENAAL trials demonstrating renal protection in type 2 diabetes.
The TxGNN model predicts it may be effective for **Malignant Renovascular Hypertension**, with **no clinical trials** and **no directly relevant publications** currently identified for this specific indication, though strong ARB class-effect mechanistic rationale provides indirect support.
The high prediction score (99.31%) reflects the precise alignment between Irbesartan's RAAS-blocking mechanism and the pathophysiology of renovascular hypertension.
