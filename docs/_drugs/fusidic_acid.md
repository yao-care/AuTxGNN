...
**Rationale:**
Evidence for exposure keratitis is limited to a single tier-3 case series with no supporting clinical trials, and TxGNN itself stages this candidate at the earliest evidence tier ("Research Question", S1). This is insufficient to justify progression at this time.
