...
description: "How AuTxGNN produces and validates predictions: TxGNN knowledge graph prediction, evidence collection, L1-L5 grading, and decision recommendations."
---
...
<p class="key-answer" data-question="How does AuTxGNN produce its predictions?">
...
<li><strong>Evidence collection</strong>: for each predicted pair, evidence is gathered from ClinicalTrials.gov, PubMed, DrugBank and TGA.</li>
...
Drug approval data for Australia comes from TGA. Ingredient names are mapped to the
