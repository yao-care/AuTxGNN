...
import pandas as pd
from autxgnn.collectors import DrugBundleAggregator
from autxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from autxgnn.collectors.drug_bundle import PredictedIndication
    from autxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from autxgnn.collectors.drug_bundle import DrugBundle
