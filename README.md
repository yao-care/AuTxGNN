# AuTxGNN - Australia: Drug Repurposing

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> AuTxGNN 站台：<https://autxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-autxgnn.yao.care-blue)](https://autxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for Australia TGA-approved drugs using the TxGNN model.
...
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 729 MK / 50,000 CUD |
...
| **L5** | 729 | Computational prediction only |
...
| Metric | Value |
|------|------|
| TGA Total Drugs | 1,235 |
| Repurposing Candidates | 12,434,566 |

### Deep Learning Method

```bash
conda activate txgnn
PYTHONPATH=src python -m autxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 1,404,249 |
| Unique Drugs | 729 |
| Unique Indications | 17,081 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: TGA, DDI, DrugBank"]
...
| File | Download |
|------|------|
| TGA Data | [Australian Register of Therapeutic Goods (ARTG)](https://www.tga.gov.au/resources/artg) |
...
|------|------|------|------|
| **Drug Data** | TGA | [Australian Register of Therapeutic Goods (ARTG)](https://www.tga.gov.au/resources/artg) | Australia |
...
```mermaid
flowchart TD
    FDA["TGA Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["au_fda_drugs.json"]
...
```bibtex
@software{autxgnn2026,
  author       = {Yao.Care},
  title        = {AuTxGNN: Drug Repurposing Validation Reports for Australia TGA Drugs},
  year         = 2026,
  publisher    = {GitHub},
  url          = {https://github.com/yao-care/AuTxGNN}
}
```
